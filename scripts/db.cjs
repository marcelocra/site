(async () => {
  ...
  const uri = keyValueEnvs.get("NEO4J_CONNECTION_URI");
  const user = keyValueEnvs.get("NEO4J_USER");
  const password = keyValueEnvs.get("NEO4J_PASSWORD");
